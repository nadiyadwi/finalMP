...
public class Write_Diary_Activity extends AppCompatActivity {
    ...
    private void saveDiaryToFirestore(String text) {
        ...
        db.collection("diaries")
                ...
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(Write_Diary_Activity.this, "Diary saved successfully!", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> Toast.makeText(Write_Diary_Activity.this, "Failed to save diary", Toast.LENGTH_SHORT).show());
    }
}
